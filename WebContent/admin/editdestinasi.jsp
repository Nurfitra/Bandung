    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Destinasi <small>Edit Destinasi</small>
                        </h1>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form method="post" action="Admin?action=editDestinasi">
                        <%
						...
						%>
							<input type="text" name="postId" value="<%=post.getPid()%>" hidden>
                            <div class="form-group">
                                <label>Nama Destinasi</label>
                                <input type="text" class="form-control" value="<%=post.getJudul()%>" name="judul" required>
                            </div>
                            <div class="form-group">
                                <label>Gambar</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" name="deskripsi" required><%=post.getIsi()%></textarea>
                            </div>
                            <div class="form-group">
