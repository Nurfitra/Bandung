    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <form method="post" action="Admin?action=editEvent">
                        <%
						...
						%>
							<input type="text" name="eventId" value="<%=event.getEid()%>" hidden>
                            <div class="form-group">
                                <label>Nama Event</label>
                                <input type="text" class="form-control" value="<%=event.getEvent()%>" name="event" placeholder="Username" required>
                            </div>
                            <div class="form-group">
                                <label>Gambar</label>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" rows="3" name="deskripsi" placeholder="Deskripsi" required><%=event.getIsi()%></textarea>
                            </div>
