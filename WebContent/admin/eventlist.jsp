...
<%
	...
	List<EventBean> eventList = dao.getAllEvents();
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Event <small>Manage Event</small>
                        </h1>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <a href="Admin?action=addformEvent" class="btn btn-primary">Add Event</a>
                    </div>
                </div><br/>
                <div class="row">
                    <div class="col-lg-6">
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>zz</td>
                                        <td>
                                        <a href="Admin?action=editformEvent&eventId=<%=event.getEid()%>" class="btn btn-xs btn-success">Edit</a>
                                        <a href="Admin?action=deleteEvent&eventId=<%=event.getEid()%>" class="btn  btn-xs  btn-danger">Hapus</a>
                                        </td>
                                    </tr>
									<%
									no += 1;
